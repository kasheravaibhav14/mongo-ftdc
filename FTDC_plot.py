...
class FTDC_plot:
    '''
    Python class to handle rendering of metric plots in SVG and a summary of report generated by Chatgpt in the output PDF.
    
    '''
    def __init__(self, df, to_monitor, vert_x, gpt_out="", outfilepath="report.pdf"):
        self.df = df  # DataFrame containing the data to be plotted
        self.to_monitor = to_monitor  # Parameters to monitor in the plot
        self.outPath = outfilepath  # Path for output PDF file, default is "report.pdf"
        self.vert_x = vert_x  # Represents a vertical line in the x-axis of the plot
        self.subheadings = ["ss wt", "ss", "ss metrics", "sm", "ss tcmalloc"]  # List of subheadings for the report
        self.expandedSub = {"ss wt": "wiredTiger", "ss": "Server status",  # Dictionary mapping subheadings to full forms
                            "ss metrics": "Query metrics", "sm": "System metrics", "ss tcmalloc": "tcmalloc"}
        self.markdown_string = gpt_out  # Stores output from Chatgpt
